...
#define DT_ASSET_ROOT CMAKE_SOURCE_DIR "/extern/D-Type/exec/d-text/"
...
#include "core-cpp/dtype_l4.h"
// D-Type's platform independent window support
#include <DTWindow.cpp>
// #include "utils/dtwindow.h"
// D-Type's extra system utility functions
#include "utils/dtxsystem.h"
// D-Type CPP Engine
...
bool CDTApplet::Init()
{
    ...
    DT_STREAM_FILE(sa, DT_ASSET("../../files/raw/base_180x165_8bpp.raw"));  LoadBitmap(BitmapA, 180, 165, sa);
    DT_STREAM_FILE(sb, DT_ASSET("../../files/raw/menu2_180x165_8bpp.raw")); LoadBitmap(BitmapB, 180, 165, sb);
...
bool CDTApplet::InitDoc_00()
{
    ...
    */
    ...
    DT_STREAM_FILE(stream_fmap, DT_ASSET("config/fontmap.inf"));
...
int main(int main_argc, char* main_argv[])
{
    ...
    auto ret= cd(p);
    std::cout << "--------------------------------------------------\n";
    std::cout << "core-cpp/d-TYPE UNICODE TEXT MODULE OUTPUT DEMO\n";
    ...
    std::cout << "------------------------------\n";
    std::cout << "\n";
    std::cout << "core-cpp/dO NOT CLOSE THIS CONSOLE WINDOW WHILE THE PROGRAM IS RUNNING!\n";
    std::cout << "TO QUIT THE PROGRAM, CLOSE ALL OTHER OPEN WINDOWS.\n";
    std::cout << "\n";

    CDTEngineV8 engine;

    DT_STREAM_FILE(sd_init, DT_ASSET("config/dtype.inf"));
    DT_STREAM_FILE(sd_fontmap, DT_ASSET("config/fontmap.inf"));
    ...
    CDTApplet applet(engine, display, "core-cpp/d-Type Example", display.Dist(1024), display.Dist(760), DV_WINDOW_HINT_RESIZE | DV_WINDOW_HINT_CENTER | DV_WINDOW_HINT_FULLRESOLUTION /* | DV_WINDOW_HINT_RGB */);
